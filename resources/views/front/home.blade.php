                            ...
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    ...
                                    @if (!empty($productImage->image))
                                        <img src="{{ asset('uploads/' . $productImage->image) }}" class="card-img-top"
                                            width="50" style="height: 17rem">
                                    @else
                                        <img src="{{ asset('flower.avif') }}" class="card-img-top" width="40">
                                    @endif
                                    </a>
                        ...
                        @foreach ($latestProducts as $product)
                            ...
                            <div class="col-md-3">
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        @if (!empty($productImage->image))
                                            <img src="{{ asset('uploads/' . $productImage->image) }}"
                                                class="card-img-top" width="50" style="height: 17rem">
                                        @else
                                            <img src="{{ asset('flower.avif') }}" class="card-img-top" width="40">
                                        @endif
                                        </a>
